 ...
 * @author Simon Hess
 * 
 * With this strategy no expectation is computed. Instead values must be updated automatically.
 *
 */
public class NoExpectation implements Expectation {
...
//		double result=1*passedValues[0][0]+(1-1)*passedValues [0][1];
