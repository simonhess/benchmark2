...
public class AdaptiveMarkupOnIBRateExpectedVsActualValue extends AbstractStrategy implements
MarkupInterestRateStrategy {
	...
	public double computeInterestRate(MacroAgent creditDemander, double amount, int length) {
		...
		double interbankRate = lender.getInterestRate(StaticValues.MKT_INTERBANK);

		double iR = interbankRate + markup;
