...
public class ConsumptionFixedPropensitiesOOIWWithPersistency extends AbstractStrategy
	...
	public double computeRealConsumptionDemand() {
		...
		double netWealth=household.getPassedValue(StaticValues.LAG_NETWEALTH, 1);

		double demand=persistency*pastConsumption+(1-persistency)*(propensityOOI*(netIncome/priceExpectation)+propensityOOW*((netWealth-household.getDividendsReceived())/priceExpectation));
