...
public class MonetaryTaylorWithSmoothing extends AbstractStrategy implements
	...
	public double computeAdvancesRate() {
		...
		double AdvancesRate = previosAdvancesRate*smoothingParameter+(1-smoothingParameter)*(inflation + naturalRateOfInterest + inflationCoefficient*(inflation - targetInflation) + outputGapCoefficient* (Math.log(realGDP) - Math.log(potentialGDP)));
