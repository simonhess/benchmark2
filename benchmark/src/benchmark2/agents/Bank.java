...
import benchmark2.strategies.PriciestBorrower;
...
//			ms.getMarket(benchmark2.StaticValues.MKT_ADVANCES).commit((MacroAgent) this, cb, benchmark2.StaticValues.MKT_ADVANCES);
//			this.setActive(true, StaticValues.MKT_ADVANCES);
//		}
